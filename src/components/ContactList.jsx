...
import { addContacts, setSearched } from "../redux/service/contactSlice";
    ...
    ?.map((contact) => {
      return (
        <tr className="contact-list" key={contact?.id}>
          <td>{contact?.name === null ? "exampleName" : contact?.name}</td>
          <td>
            {contact?.email === null ? "example@gmail.com" : contact?.email}
          </td>
          <td>{contact?.phone === null ? "exampleNum" : contact?.phone}</td>
          <td>
