      ...
      <div className="flex justify-center items-center h-screen bg-gradient-to-r from-[#e5e5f6] to-blue-500">
        ...
        <div className="xl:w-96 md:w-96 w-80 flex flex-col gap-8 bg-[#ffffff19] backdrop-blur-sm border-t-[rgba(255,255,255,0.5)] border-l-[rgba(255,255,255,0.5)] border-solid border-t border-l rounded-lg p-[2.9rem]">
          ...
          <div className="flex justify-around items-center">
            <div className="bg-blue-600 transition duration-300 text-white hover:bg-gray-500 px-4 py-1 rounded-lg w-24 md:w-32 lg:w-32 h-12 mx-auto block">
              <Skeleton height={8} mt={6} width="40%" radius="xl" />
            </div>
            <div className="bg-gray-500 transition duration-300 text-white hover:bg-blue-600 px-4 py-1 rounded-lg w-24 md:w-32 lg:w-32 h-12 mx-auto block">
              <Skeleton height={8} mt={6} width="40%" radius="xl" />
            </div>
          </div>
        </div>
