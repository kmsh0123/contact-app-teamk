...
const Detail = () => {
  ...
  return (
    <div>
      ...
      <div className="bg-gradient-to-r from-[#e5e5f6] to-blue-500 px-10">
        <div className=" flex flex-col gap-10 w-full">
          ...
          <div className=" img flex flex-col md:flex-row justify-center gap-14 items-center mt-12">
            ...
            <div className=" flex flex-col gap-3">
              ...
              <div>
                <button className=" flex items-center shadow py-2 px-4 font-sans font-normal bg-blue-500 rounded">
                  Add Label
                  <SlPlus className=" ms-2 text-gray-7  00" />
                </button>
              </div>
          ...
          <div className=" flex flex-col md:flex-row justify-center gap-5">
            {/* contact info */}
            <div>
              <div className="bg-blue-500 shadow-lg rounded-2xl px-4 py-6 w-auto md:w-[500px]">
            ...
            {/* recent interaction */}
            <div>
              <div className="bg-blue-500  shadow-lg rounded-2xl px-4 py-6 md:w-[450px]">
